...
import ImageSign from '../assets/image/imgmasuk.png'
...
export default function Masuk() {
  ...
  return (
    <div className='grid grid-cols-2 bg-fifth'>
        <img alt='image' src={ImageSign}/>
        <div className='px-[100px] py-[150px]'>
          <h1 className='font-bold text-6xl text-white'>HALLO PHILE SELAMAT DATANG</h1>
          ...
          <form>
            ...
            <div className='mt-9'>
              <div className='flex justify-between gap-2'>
                  <p className='font-medium text-sm text-white'>Lupa Password?</p>  
                  <p className='font-medium text-sm text-white underline underline-offset-4'>Ingatkan sandi</p> 
              </div>
            </div>
            <div className=' flex justify-center mt-9'>
              <button onClick={() => navigate('/')} className='w-3/4 bg-white px-[18px] py-2 rounded-[9px] font-bold hover:bg-secondary/50 text-black'>
                Masuk
              </button>
            </div>
            ...
            <div className='mt-5'>
              <p className='flex justify-center text-white text-sm'>
               Belum punya akun ? 
              <Link to="/daftar" className="text-white underline ml-1">
                Daftar
              </Link>
              </p>
            </div>
