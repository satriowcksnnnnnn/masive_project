...
import image from "../../public/images/Beritaimg2.png";
    ...
    <div className="bg-primary py-[135px] text-white px-28">
      ...
      <div className="flex gap-9 mt-6">
        ...
        <div className="w-[754px] my-auto">
          ...
          <h2 className="text-xl mt-[14px] text-justify">
            Pertunjukan ini berkisah tentang seorang ayah dan anak yang sering
            beradu argumen karena si ayah selalu saja bersantai setiap harinya,
            karena tak kunjung mempunyai pekerjaan.
          </h2>
